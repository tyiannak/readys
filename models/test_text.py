...
if __name__ == '__main__':
    ...
    parser.add_argument("-i","--input", help="the path of our data samples (csv with column transcriptions and one column labels)")
    parser.add_argument("-p","--pretrained", help="the path of fasttext pretrained model (.vec file)")
    parser.add_argument("-c","--classifier", help="the path of the classifier")
    parser.add_argument("-n","--names" ,help = "the path of csv file that contains the name of classes of this specific model")
    args = parser.parse_args()
    predict_text_labels(args.input,args.pretrained,args.classifier,args.names)
